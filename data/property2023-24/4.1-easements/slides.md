...
3. Accommodation (enhancement) of the dominant lands; and
...
As the court notes, easements of necessity will only be recognized when they are:

1. absolutely necessary for the use of the dominant lands and
2. when such necessity existed at the time when the land was severed. 

While these two requirements appear relatively straightforward, the two judges in Nelson clearly disagree about how broadly easements of necessity should be available.
...
Now, owners of lots in Plan 320 (the new Winch subdivision) use RoW over Lot 33 to get to the beach. Laurie, current owner of Lot 33, wants to stop them from doing this. Claim is that original easement is not longer used and should therefore be extinguished.

KEY ISSUE: what is the SCOPE of the RoW over Lot 33? Does the use of RoW by subdivision residents exceed the original scope?
